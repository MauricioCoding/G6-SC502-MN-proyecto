...
<?php include('views/partials/navbarAdmin.php'); ?>
...
<section id="top-tittle" class="hero-section rounded-4 shadow mb-5">
  <div class="container py-5 text-center">
    ...
    <div class="mb-4">
      <img src="./assets/img/Ejemplo enchape.jpg" class="img-fluid rounded" alt="Imagen principal">
    </div>
    ...
    <div class="row align-items-center g-4">
      <div class="col-md-6">
        <div class="image-frame rounded-4 shadow-sm">
          <img src="./assets/img/logoCompleto.png" class="img-fluid rounded-4" alt="Quiénes somos">
        </div>
      </div>
      <div class="col-md-6">
